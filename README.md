...
- AI suggestion of which installed profile suits the bean in front of you, ranked with a reason for each, run automatically after a label scan and saved with the bean
